# this script mustI be run manually at any folder containing repository for check
...
# now we have in nevw branch needed changes, last master state and no sensitive info
...
{
   Git diff origin\mov_secr_az origin\mov_secr_az_mrg
}
